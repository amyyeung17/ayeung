<template>
  <div class="flex flex-col px-3">
    ...
    <a 
      href="https://docs.google.com/document/d/1VfOC1F-quIiwHxTDLX2qfvS0dPmff8wzdNdBJr6Lm6w/edit?usp=sharing"
      class="bg-secondary text-primary rounded-full border-2 border-secondary py-2 px-4 my-2 hover:text-primary hover:ring-2 w-28 self-center"
      target="_blank"  
    > 
      Download 
  </a>
