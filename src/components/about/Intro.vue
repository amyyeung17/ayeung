...
<template>
  <div class="text-primary-100 p-2 relative top-4 whitespace-pre-line">
    I'm a first-gen graduate of the University of Pennsylvania, earning a Bachelor of Applied Science in Computer and Cognitive Science in 2021.
    ...
    In my downtime, I've been running a lot and practicing archery. Go birds. 
    {{`\n \n`}}
