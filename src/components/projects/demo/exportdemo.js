import vaimage1 from './va/1.png'
import vaimage2 from './va/2.png'
import vagif from './va/sampleopt.gif'

import taskimage1 from './task/1.png'
import taskimage2 from './task/2.png'
import taskimage3 from './task/3.png'
import taskstopgif from './task/stopopt.gif'
...
export const taskDemo = [taskimage1, taskimage2, taskimage3, taskstopgif]

export const spotifyDemo = [spotimage1, spotgif1, spotimage3, spotgif2, spotgif3]

export const socialDemo = [socialimage1, socialgif1, socialgif2, socialimage3, socialimage4]
