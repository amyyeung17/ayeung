const contactInfo = [
  ...
  {text: 'Github', icon:'github', link: 'https://github.com/amyyeung17', linktext: 'amyyeung17'},
  {text: 'Linkedin', icon: 'linkedin', link: '/', linktext: 'Amy Yeung'},
  {text: 'Resume', icon: 'file-earmark-person', link: '/', linktext: 'Download'}
]
